    ...
    <>
     ...
     <Dialog title="Example Modal" onClose={onClose} onOk={onOk}>
        <p>
          ...
          labore, velit quasi ipsam asperiores voluptatum minus odio odit, optio
          et neque delectus provident vero non beatae adipisci distinctio a
          commodi.
        </p>
      </Dialog>
      ...
      <p>
        ...
        odio ipsa nostrum dolores voluptas architecto tempore nulla voluptatibus
        vel, placeat explicabo exercitationem id officia laborum doloremque
        blanditiis earum accusamus.
      </p>
